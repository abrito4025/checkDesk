			...
			<div class="full-box nav-lateral-content">
				...
				<nav class="full-box nav-lateral-menu">
					<ul>
						...
						<li>
							<a href="#" class="nav-btn-submenu"><i class="fas fa-pallet fa-fw"></i> &nbsp; Mantenimiento <i class="fas fa-chevron-down"></i></a>
							<ul>
								<li>
									<a href="<?php echo ServerUrl; ?>mantenimiento-new/"><i class="fas fa-plus fa-fw"></i> &nbsp; Agregar mantenimiento</a>
								</li>
								<li>
									<a href="<?php echo ServerUrl; ?>mantenimiento-list/"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; Lista de mantenimientos</a>
								</li>
								<li>
									<a href="<?php echo ServerUrl; ?>mantenimiento-search/"><i class="fas fa-search fa-fw"></i> &nbsp; Buscar mantenimiento</a>
								</li>
							</ul>
						</li>
